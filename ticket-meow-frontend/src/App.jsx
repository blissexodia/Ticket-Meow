          ...
          <div style={{ display: "flex", flex: 1 }}>
            ...
            <div style={{ flex: 1 }}>
              <Routes>
                ...
                <Route
                  path="/book-tickets/movies"
                  element={<MovieTickets />}
                />
                <Route
                  path="/book-tickets/movies/:movieId"
                  element={<MovieDetails />}
                />
                <Route
                  path="/book-tickets/events"
                  element={<EventTickets />}
                />
                <Route
                  path="/book-tickets/events/:eventId"
                  element={<EventDetails />}
                />
                <Route
                  path="/book-tickets/concerts"
                  element={<ConcertTickets />}
                />
                <Route
                  path="/book-tickets/concerts/:concertId"
